...
public class fr_completedorders extends Fragment implements AsyncResponse, filterDialog.BottomSheetListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_fr_completedorders, container, false);
        Toolbar mtoolbar = (Toolbar) v.findViewById(R.id.toolbar);
        ((AppCompatActivity) getActivity()).setSupportActionBar(mtoolbar);
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Completed Orders");
        ...
        /*recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener()
        {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy)
            {
                if (dy > 0 )
                {
                //    Main2Activity.bottomNavigationView.startAnimation(slideUp);
    ...
    public boolean onOptionsItemSelected(MenuItem items) {
        ...
        switch (id) {
            ...
            case R.id.menu_filter:
                ...
                bs.setTargetFragment(fr_completedorders.this, 1);
...
//        String[] myTaskParams = {"/SSMCompletedOrderList", jsonParam.toString()};
        String[] myTaskParams = {"/SSMNewOrderListProduct", jsonParam.toString()};
        //  new HMDataAccess().execute(myTaskParams);
        try {
            HMDataAccess aasyncTask = new HMDataAccess(this.getContext(), progressBar4x, "SSMCompletedOrderList");
            aasyncTask.delegate = (AsyncResponse) fr_completedorders.this;
    ...
    public void processFinish(String output, String handle) throws HMOwnException, JSONException {
        ...
        adapter = new timeLineAdapter(getActivity(), ar, R.layout.timeline_card, false, timeLineAdapter.COMPLETE_ORDER);
