 ...
 */
public class fr_confirm_request_post extends Fragment {
    private TextView lblorder, lblmessage, mTitle;
    private Button btnhome;
    private Toolbar mtoolbar;

    public fr_confirm_request_post() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (getArguments().getString("message").contains("New"))
            ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("New employee");
        else
            ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Profile Update");
