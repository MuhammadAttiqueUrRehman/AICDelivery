...
public class fr_loadorders extends Fragment implements AsyncResponse, filterDialog.BottomSheetListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_fr_complainorders, container, false);
        Toolbar mtoolbar = (Toolbar) v.findViewById(R.id.toolbar);
        ((AppCompatActivity) getActivity()).setSupportActionBar(mtoolbar);
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Load orders");
    ...
    public boolean onOptionsItemSelected(MenuItem items) {
        ...
        switch (id) {
            ...
            case R.id.menu_filter:
                ...
                bs.setTargetFragment(fr_loadorders.this, 1);
...
//        String[] myTaskParams = {"/SSMComplainOrderList", jsonParam.toString()};
        String[] myTaskParams = {"/SSMNewOrderListProduct", jsonParam.toString()};
        //  new HMDataAccess().execute(myTaskParams);
        try {
            HMDataAccess aasyncTask = new HMDataAccess(this.getContext(), progressBar4x, "SSMComplainOrderList");
            aasyncTask.delegate = (AsyncResponse) fr_loadorders.this;
    ...
    public void processFinish(String output, String handle) throws HMOwnException, JSONException {
        ...
        adapter = new timeLineAdapter(getActivity(), ar, R.layout.timeline_card, false, timeLineAdapter.ONLOAD_ORDER);
