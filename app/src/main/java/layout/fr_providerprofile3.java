 ...
 */
public class fr_providerprofile3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (providerinfo.getProfileImage().length() > 0) {
            Log.i("Debugging", "profile  " + providerinfo.getProfileImage());
        ...
        if (providerinfo.getAadharImage().length() > 0) {
            Log.i("Debugging", "aadhar  " + providerinfo.getAadharImage());
        ...
        if (providerinfo.getTradeImage().length() > 0) {
            Log.i("Debugging", "Trade  " + providerinfo.getTradeImage());
        ...
        if (providerinfo.getDLImage().length() > 0) {
            Log.i("Debugging", "DL  " + providerinfo.getDLImage());
            ...
            public void onClick(View v) {
                ...
                if (txtaadhar.getText().length() > 0) {
                    if (txtaadhar.getText().length() != 15) {
                        txtaadhar.setError("The Resident ID Card number should be 15 digits");
                        return;
                    }
                }
                ...
                Fragment myFragment = new fr_providerprofile4();
