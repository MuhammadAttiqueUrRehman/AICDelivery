...
public class fr_version_pre extends Fragment implements AsyncResponse {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragement_fr_version_pre, container, false);
        ...
        aboutinfo = v.findViewById(R.id.taboutinfo);
        lblversion = v.findViewById(R.id.lblversion);
        progressBar13 = v.findViewById(R.id.progressBar13);
        ...
        try {
            ...
            aasyncTask.delegate = (AsyncResponse) fr_version_pre.this;
